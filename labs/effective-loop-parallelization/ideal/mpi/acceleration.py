...
def print_clolored(str):
    print(colored(str, "magenta", "on_black", ['bold']))
...
def main() -> int:
    ...
    print_clolored(f"Saving graph to {current_dir}/Acceleration.png")
    ...
    plt.grid()
    current_dir = os.getcwd()
    print_clolored(f"Saving graph to {current_dir}/Efficiency.png")
